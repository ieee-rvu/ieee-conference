  ...
  return (
    <div className="absolute inset-0">
      ...
      <div className="relative z-10 p-8 w-full h-full flex flex-col items-center justify-center">
        <div
          className={`h-full bg-gray-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-50 border border-gray-100 flex flex-col items-center justify-center overflow-y-scroll`}
        >
          <div
          ...
          >
            <div className={`basis-3/4`}>
              ...
              <div className={`md:text-justify`}>
                ...
                technology enthusiasts to explore the transformative role of
                computing in addressing modern challenges and shaping a
                sustainable future.
                <br />
                <br />
                The conference emphasizes areas such as green computing,
                artificial intelligence, cloud and edge computing, quantum
                computing, cybersecurity, and sustainable software engineering.
                It aims to foster collaboration, encourage knowledge sharing,
                and inspire research that aligns with global sustainability
                goals.
                <br />
                <br />
                ...
                the opportunity to engage in discussions on cutting-edge
                research and emerging trends in computing. Join us to explore
                how futuristic computing technologies can lead us toward a
